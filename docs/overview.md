...
```json
{
  "mcpServers": {
    "listmonk-api": {
      "command": "uv",
      "args": ["run", "--with", "listmonk-api", "listmonk-mcp"],
      "env": {}
    }
  }
}
...
```bash
listmonk-mcp --transport streamable-http --port 8001
```
