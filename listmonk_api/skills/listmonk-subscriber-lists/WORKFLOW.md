...
```json
{"email":"[REDACTED_EMAIL]","name":"Jane Doe","status":"enabled","lists":[3,7],"preconfirm_subscriptions":true}
```
...
```json
{"file":"email,name\[REDACTED_EMAIL],Joe","mode":"subscribe","delim":",","lists":[3],"overwrite":true}
```
